<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Vistas/Temp/master_loged_in.Master" AutoEventWireup="true" UnobtrusiveValidationMode="None"
     CodeBehind="web_07_reservaServicio.aspx.cs" Inherits="FrontOffice.Presentacion.Vistas.Web.Reservas.web_07_reservaServicio" %>
     ...
     <asp:Table ID="tabla" runat="server" HorizontalAlign="Center" CssClass ="tabla"> 
               <asp:TableRow>
                ...
                <asp:RegularExpressionValidator id="RegularExpressionValidator2" runat="server" 
                   ...
                   <asp:TableCell>
                       <asp:TextBox ID="tb_cantidad" MaxLength="30" runat="server" CssClass="textbox" TextMode="Number" ></asp:TextBox>
