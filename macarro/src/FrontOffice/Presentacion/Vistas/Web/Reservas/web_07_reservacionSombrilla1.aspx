<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Vistas/Temp/master_loged_in.Master" UnobtrusiveValidationMode="None"
    ...
    Inherits="FrontOffice.Presentacion.Vistas.Web.Reservas.web_07_reservacionSombrilla1" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <div id="reservar" >            
     <asp:Table ID="tabla" runat="server" HorizontalAlign="Center" CssClass ="tabla"> 
         ...
         <asp:Button CssClass="Boton" ID="Button2" runat="server"  Text="Cancelar" OnClick="Button2_Click" OnClientClick = "return confirm('Está Seguro de que desea Cancelar el proceso de Reserva?')" />
    </div>
