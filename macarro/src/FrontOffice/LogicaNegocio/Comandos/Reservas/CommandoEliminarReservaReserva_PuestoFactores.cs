...
{
    public class CommandoEliminarReservaReserva_PuestoFactores : Comando<int[], bool>
    {
        public override bool Ejecutar(int[] parametro)
        {
            try
            {
                ...
                return _daoReservaServicio.EliminarReservaReserva_PuestoXIdReservaXFilaXColumna(parametro);
