<%@ Page Language="C#" MasterPageFile="~/Interfaz/temp/master_not_loged.Master" AutoEventWireup="true" 
    ...
    Inherits="front_office.Interfaz.web.IngresoRecuperacionClave.web_01_recuperarContrasena" %>
...
<div class="content01" >
    ...
    <table align="center" style="width:40%" >
       ...
       <tr>
            <td></td>
            <td> 
                <asp:label CssClass="labels" ID="Label1" runat="server" Text="Contrase&ntilde;a"></asp:label> 
      ...
      <tr>
            <td></td>
            <td> 
                <asp:Label CssClass="labels" ID="CcontrasenaL" runat="server" Text="Confirmar Contrase&ntilde;a"></asp:Label> 
            </td>
            <td> 
