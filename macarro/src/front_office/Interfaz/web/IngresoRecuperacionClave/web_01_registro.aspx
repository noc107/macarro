<%@ Page UnobtrusiveValidationMode="None" Title="" Language="C#" MasterPageFile="~/Interfaz/temp/master_not_loged.Master" AutoEventWireup="true" CodeBehind="web_01_registro.aspx.cs" Inherits="front_office.Interfaz.web.IngresoRecuperacionClave.web_01_registro" %>
...
<div class="content01" >
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td> <asp:TextBox CssClass="textbox" ID="input6" MaxLength="40" runat="server" ></asp:TextBox> 
                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="input6" 
                    Text="*" ErrorMessage="E-mail inválido" ForeColor="Red" 
                    ValidationExpression="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$">
                </asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate ="input6"
                    Text="*" ForeColor="Red" ErrorMessage="Debe ingresar un E-mail">
                </asp:RequiredFieldValidator>
            </td> 
        ...
        <tr>
            ...
            <td> <asp:TextBox CssClass="textbox" ID="input10" MaxLength="11" runat="server"></asp:TextBox> 
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate ="input10"
                    Text="*" ForeColor="Red" ErrorMessage="Debe ingresar un teléfono">
                </asp:RequiredFieldValidator>
            </td> 
            <td> <asp:Label CssClass="labels" ID="label15" runat="server" Text="Tel&eacute;fono (*) :"></asp:Label> </td>
            <td> </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator CssClass="ValidacionPais" ID="RequiredFieldValidator7" runat="server" 
                    ControlToValidate ="DropDownList3" ErrorMessage="Seleccionar un país" 
                    InitialValue="Seleccione" Text="*" ForeColor="Red">
                </asp:RequiredFieldValidator>
            </td>
            <td><asp:Label CssClass="labels" ID="label16" runat="server" Text="Direcci&oacute;n (*) :"></asp:Label></td>
        ...
        <tr>
            <td><asp:Label CssClass="labels" ID="label17" runat="server" Text="Estado (*) :"></asp:Label></td>
            <td>
                <asp:DropDownList class="DropDownList" ID="DropDownList4" runat="server">
                    <asp:ListItem> Seleccione </asp:ListItem>
                    <asp:ListItem>Dtto Capital</asp:ListItem>
                </asp:DropDownList> 
                <asp:RequiredFieldValidator CssClass="ValidacionEstado" ID="RequiredFieldValidator8" runat="server" 
        ...
        <tr>
            <td><asp:Label CssClass="labels" ID="label18" runat="server" Text="Ciudad (*) :"></asp:Label></td>
            <td>
                <asp:DropDownList class="DropDownList" ID="DropDownList5" runat="server">
                    <asp:ListItem> Seleccione </asp:ListItem>
                    <asp:ListItem>Caracas</asp:ListItem>
                </asp:DropDownList> 
                <asp:RequiredFieldValidator CssClass="ValidacionCiudad" ID="RequiredFieldValidator10" runat="server" 
        ...
        <tr>
            <td></td>
            <td colspan="2"><asp:ValidationSummary ID="ValidationSummary1" HeaderText="" DisplayMode="BulletList"
