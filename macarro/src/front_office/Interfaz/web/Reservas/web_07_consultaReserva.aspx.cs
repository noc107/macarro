...
namespace front_office.Interfaz.web.Reservas
{
    ...
    public partial class web_07_consultaReserva : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _tabla.Rows.Add("Moto de Agua", "2", "22/12/2014", "2:00pm", "4:00pm", "500$", "En espera");
            _tabla.Rows.Add("Tumbona", "2", "22/12/2014", "2:00pm", "4:00pm", "500$", "En espera");
            _tabla.Rows.Add("Banana", "2", "22/12/2014", "2:00pm", "4:00pm", "500$", "En espera");
            _tabla.Rows.Add("Raquetas de Playa", "2", "22/12/2014", "2:00pm", "4:00pm", "500$", "En espera");
            _tabla.Rows.Add("Lancha", "2", "22/12/2014", "2:00pm", "4:00pm", "500$", "En espera");
            _tabla.Rows.Add("Pelota", "2", "22/12/2014", "2:00pm", "4:00pm", "500$", "En espera");
