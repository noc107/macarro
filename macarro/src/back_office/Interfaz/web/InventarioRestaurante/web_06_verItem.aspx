<%@ Page Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" AutoEventWireup="true" CodeBehind="web_06_verItem.aspx.cs" Inherits="back_office.Interfaz.web.InventarioRestaurante.web_06_verItem" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="middle_place_holder" runat="server">
   ...
   <div ID="Formulario2" class="Bloque">
       ...
       <asp:Label ID="lbNombreVer" CssClass="labels TextoVerNombre" runat="server" Text="Pasta" ></asp:Label>
   
       
        <asp:Label ID="Label2" CssClass="labels LabelVerCantidad" runat="server" Text="Cantidad:" ></asp:Label>
        <asp:Label ID="lbCantidadVer" CssClass="labels TextoVerCantidad" runat="server" Text="20"></asp:Label>
    
       
        <asp:Label ID="Label3" CssClass="labels LabelVerDescripcion"  runat="server" Text="Descripción:" ></asp:Label>
        <asp:Label ID="lbDescripcionVer" CssClass="labels TextoVerDescripcion"  runat="server" Text="Este es un item" ></asp:Label>
        
        <asp:Label ID="Label6" CssClass="labels LabelVerPrecioVenta" runat="server" Text="Precio Venta:" ></asp:Label>
        <asp:Label ID="lbPrecio" CssClass="labels TextoVerPrecioVenta" runat="server" Text="500"></asp:Label>

        <asp:Label ID="Label7" CssClass="labels LabelVerPrecioCompra"  runat="server" Text="Precio Compra:" ></asp:Label>
        <asp:Label ID="lbPrecio2" CssClass="labels TextoVerPrecioCompra" runat="server" Text="400" ></asp:Label>

        <asp:Label ID="Label4" CssClass="labels LabelVerProveedor" runat="server" Text="Proveedor:"  ></asp:Label>
        <asp:Label ID="lbProveedor" CssClass="labels TextoVerProveedor"  runat="server" Text="Proveedor 1"  ></asp:Label>
