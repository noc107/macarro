<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" UnobtrusiveValidationMode="None" CodeBehind="web_14_buscarMembresia.aspx.cs" Inherits="back_office.Interfaz.web.GestionVentaMembresia.web_14_buscarMembresi" %>
...
<h2>Buscar Membresia</h2>
    ...
    <div style="margin:0 auto;">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <ASP:RADIOBUTTONLIST CssClass="radio_list" ID="listaDeOpciones" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="0">Numero de Carnet</asp:ListItem>
                        <asp:ListItem Value="1">Numero de Cedula</asp:ListItem>
                    </ASP:RADIOBUTTONLIST>
                </asp:TableCell>
           </asp:TableRow>
        </asp:Table>
        ...
        <div class="marginBotonCentrar">
             <asp:Button  CssClass="Boton"  ID="btnBuscar" runat="server" Text="Buscar"  ></asp:Button>
        </div>
