<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" CodeBehind="web_14_consultarMembresia.aspx.cs" Inherits="back_office.Interfaz.web.GestionVentaMembresia.web_14_consultarMembresia" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <div style="margin:0 auto;">
        ...
        <asp:Table ID="tabla" runat="server" HorizontalAlign="Center">
            ...
            <asp:TableRow>
                <asp:TableCell Height="50">
                    <asp:Label CssClass="labels" ID="Label7" runat="server" Text="Pais:" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell Height="50">
                    <asp:Label  CssClass="labels" ID="lbPais" runat="server" Text="" ></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell Height="50">
                   <asp:Label  CssClass="labels" ID="Label8" runat="server" Text="Estado:" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell Height="50">
                    <asp:Label CssClass="labels" ID="lbEstado"  runat="server" Text="" ></asp:Label>
               </asp:TableCell>
                <asp:TableCell Height="50">
                    <asp:Label  CssClass="labels" ID="Label9" runat="server" Text="Ciudad:" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell Height="50">
                    <asp:Label  CssClass="labels" ID="lbCiudad" runat="server" Text="" ></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label  CssClass="labels" ID="Label14" runat="server" Text="Direccion:" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:Label CssClass="labels" ID="lbDireccion" runat="server" Text="" ></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell Height="50">
