<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" UnobtrusiveValidationMode="None" CodeBehind="web_14_modificarMembresia.aspx.cs" Inherits="back_office.Interfaz.web.GestionVentaMembresia.web_14_modificarMembresia" %>
    ...
    <div style="margin:0 auto;">
        ...
        <asp:Table ID="tabla" runat="server" HorizontalAlign="Center">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell Height="50">
                    <asp:DropDownList  CssClass="combo_box" ID="cbStatus" runat="server" ></asp:DropDownList>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label CssClass="labels" ID="Label1" runat="server" Text="Telefono(*):"  MaxLength="11"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label CssClass="labels" ID="Label2" runat="server" Text="Pais(*):"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    
                     <asp:DropDownList  CssClass="combo_box" ID="pais"  runat="server" ReadOnly="True" BackColor="#CCCCCC" ></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                        ControlToValidate="pais"
                        Text="*"
                        ErrorMessage="Campo de Codigo Postal Vacio."
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </asp:TableCell>
           </asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label CssClass="labels" ID="lbEstado" runat="server" Text="Estado(*):"  ></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:DropDownList  CssClass="combo_box" ID="tbEstado"  runat="server" ReadOnly="True" BackColor="#CCCCCC"></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                        ControlToValidate="tbEstado"
                        Text="*"
                        ErrorMessage="Campo de Estado Vacio."
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:Label CssClass="labels" ID="lbCiudad" runat="server" Text="Ciudad(*):" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:DropDownList   CssClass="combo_box" ID="cbCiudad" runat="server" ReadOnly="True" BackColor="#CCCCCC" ></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"
                        ControlToValidate="cbCiudad"
                        Text="*"
                        ErrorMessage="Campo de Ciudad Vacio."
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label CssClass="labels" ID="lbDireccion" runat="server" Text="Direccion(*):" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                  
                    <asp:textbox CssClass="textbox" ID="tbDireccion" runat="server" MaxLength="90" ReadOnly="True" BackColor="#CCCCCC" ></asp:textbox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"
                        ControlToValidate="tbDireccion"
                        Text="*"
                        ErrorMessage="Campo de Direccion Vacio."
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
        ...
        <div class="marginBotonCarnet">
             <asp:Button  CssClass="Boton"  ID="btnCarnet" runat="server" Text="Carnet"  ></asp:Button>
        ...
        <div>
         ...
         <asp:Table ID="Table1" runat="server" HorizontalAlign="Center" style="margin-top: 0px" Width="395px">
            <asp:TableRow>
                ...
                <asp:TableCell  CssClass="centrado">
                     <asp:Button  CssClass="Boton"  ID="btnAceptar" runat="server" Text="Guardar"  ></asp:Button>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    <br />
