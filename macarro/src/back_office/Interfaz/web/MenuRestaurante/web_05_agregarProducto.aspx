<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" AutoEventWireup="true" CodeBehind="web_05_agregarProducto.aspx.cs" Inherits="back_office.Interfaz.web.MenuRestaurante.web_05_agregarProducto" %>
...
<div  id="contenedor" class="Estilocontenedor;">
    ...
    <div class="marginBotonAgregar">
         <asp:Button ID="ButtonAgregar" CssClass="Boton" runat="server" Text="Agregar" OnClientClick="" />
         <br />
    </div>
