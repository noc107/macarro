<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="web_5_consultarTicket.aspx.cs" Inherits="back_office.Interfaz.web.ConfiguracionEstacionamientos.web_5_ConsultarTicket" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" HorizontalAlign="Center"> 
        ...
        <%-- Por Hora --%>
        <asp:TableRow ID="porHora">
            <asp:TableCell>
                <asp:Label ID="labelHoraEntrada" runat="server" Text="Hora de Entrada (*):" CssClass="labels"></asp:Label>
            </asp:TableCell>
            <asp:TableCell>
                <%-- text --%>
                <asp:TextBox ID="datetimepicker_entrada" runat="server" CssClass="textbox" TextMode="Time" ValidateRequestMode="Enabled"></asp:TextBox>
            ...
            <asp:TableCell>
                <%-- text --%>
                <asp:TextBox ID="datetimepicker_salida" runat="server" CssClass="textbox" TextMode="Time" ClientIDMode="Inherit"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow ID="porFecha">
            ...
            <asp:TableCell>
                <%-- text --%>
                <asp:TextBox ID="TextBoxFechaSalida" runat="server" CssClass="textbox" TextMode="Date" Text="12/12/2014"></asp:TextBox>
