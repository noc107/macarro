<%@ Control Language="C#" AutoEventWireup="true" 
    ...
    Inherits="back_office.Interfaz.web.ConfiguracionPuestosPlaya.componentes.formularioAgregarPuesto" %>
    ...
    <table>
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="descripcion" runat="server" CssClass="textbox inputTextbox inputTextarea" TextMode="MultiLine"></asp:TextBox>
