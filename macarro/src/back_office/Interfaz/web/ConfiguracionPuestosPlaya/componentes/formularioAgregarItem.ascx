<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="formularioAgregarItem.ascx.cs" 
    Inherits="back_office.Interfaz.web.ConfiguracionPuestosPlaya.componentes.formularioAgregarItem" %>
...
<div>    
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="cantidad" runat="server" CssClass="textbox"></asp:TextBox>
