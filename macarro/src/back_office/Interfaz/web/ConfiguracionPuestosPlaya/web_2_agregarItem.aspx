<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="web_2_agregarItem.aspx.cs" UnobtrusiveValidationMode="None"
    Inherits="back_office.Interfaz.web.ConfiguracionPuestosPlaya.web_2_agregarItem" 
    MasterPageFile="~/Interfaz/temp/back_office_temp.Master" %>

<%@ Register Src="~/Interfaz/web/ConfiguracionPuestosPlaya/componentes/formularioAgregarItem.ascx" TagPrefix="uc1" TagName="formularioAgregarItem" %>
