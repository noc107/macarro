<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" AutoEventWireup="true" CodeBehind="web_03_modificarServiciosPlaya.aspx.cs" Inherits="back_office.Interfaz.web.ConfiguracionServiciosPlaya.web_03_modificarServiciosPlaya" EnableEventValidation="false" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="middle_place_holder" runat="server"> 
    ...
    <br />
        ...
        <div class="botonesFormulario">          
            <asp:button ID="AceptarBoton" CssClass="Boton botonAceptar" text="Aceptar" runat="server" OnClick="AceptarBoton_Click"/>            
            <asp:button CssClass="botonCancelar Boton" ID="CancelarBoton" text="Cancelar" runat="server" OnClick="CancelarBoton_Click"/>
        </div>
</asp:Content>