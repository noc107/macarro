<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="web_09_gestionUsuario.aspx.cs" Inherits="back_office.Interfaz.web.UsuariosInternos.web_09_gestionUsuario" %>
    ...
    <asp:Table runat="server" HorizontalAlign="Center">
        <asp:TableRow>
            <asp:TableCell ColumnSpan="3" HorizontalAlign="Center">
                <asp:Label ID="label1" runat="server" CssClass="avisoMensaje" Text="Mensaje de confirmacion"></asp:Label>
            </asp:TableCell>
                ...
                <asp:View ID="GV_Usuario" runat="server">
                    ...
                    <asp:GridView ID="GridViewUsuario" CssClass="mGrid" AllowPaging="True" HorizontalAlign="Center" runat="server" 
                         BorderStyle="None"  AllowSorting="true" GridLines="None" AutoGenerateColumns="False"
                                             Width="510px" ForeColor="#99CCFF" PageSize="2" OnRowDataBound="GV_RowDataBound">
                       ...
                       <AlternatingRowStyle CssClass="alt" />
                         <Columns>
                            ...
                            <asp:BoundField HeaderText="Apellido" DataField="Apellido"  ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
