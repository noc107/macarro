<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master"  UnobtrusiveValidationMode="None"
    ...
    Inherits="back_office.Interfaz.web.UsuariosInternos.web_09_agregarUsuario" %>
    ...
    <asp:Table ID="Table1" runat="server" HorizontalAlign="Center"> 
       <asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:DropDownList ID="DropDownListDocumento" runat="Server" CssClass="combo_box"  DataTextField="Seleccione">
