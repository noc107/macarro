<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" AutoEventWireup="true" UnobtrusiveValidationMode="None" CodeBehind="web_09_perfil_usuario.aspx.cs" Inherits="back_office.Interfaz.web.UsuariosInternos.web_09_perfil_usuario" %>
    ...
    <asp:Table ID="Table1" runat="server" HorizontalAlign="Center"> 
       <asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:TextBox ID="TextBoxFechaNac" runat="server"  TextMode="Date" width="250" height="30" ></asp:TextBox>
            </asp:TableCell>
            <asp:TableCell HorizontalAlign="Left" Width="60px">
    ...
    <asp:Table runat="server" HorizontalAlign="Center">
        <asp:TableRow>
           <asp:TableCell ColumnSpan="6" HorizontalAlign="Center" >
               <br />
               <br />
               <asp:Button Class="Boton" runat="server" Text="Guardar"/>
           </asp:TableCell>
       </asp:TableRow>
    </asp:Table>
</asp:Content>
