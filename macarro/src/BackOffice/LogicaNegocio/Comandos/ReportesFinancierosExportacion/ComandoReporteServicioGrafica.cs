...
{
    public class ComandoReporteServicioGrafica : Comando<string[], string>
    {
        ...
        /// servicio, el metodo crea un string builder que contendrá el codigo scrip html
        ...
        /// al utilizar el metodo GetDatosIngresosServicio.
        /// </summary>
        ...
        public override string Ejecutar(string[] n)
        {
            ...
            try
            {
                _dataTable = _dao.GetDatosIngresosServicio(_fi, _ff);
                ...
                _stringBuilder.Append(@" var chart = new google.visualization.
                                    ImageLineChart(document.getElementById('servicio'));");
