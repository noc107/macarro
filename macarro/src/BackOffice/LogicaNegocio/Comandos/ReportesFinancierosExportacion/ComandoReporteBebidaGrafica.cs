...
{
    public class ComandoReporteBebidaGrafica : Comando<string[], string>
    {
        ...
        /// necesarios para realizar el reporte de las bebidas mas vendidas,
        ...
        /// al utilizar el metodo GetDataBebidas.
        /// </summary>
        ...
        public override string Ejecutar(string[] n)
        {
            ...
            try
            {
                _dataTable = _dao.GetDatosBebidas(_fi, _ff);
                ...
                _stringBuilder.Append(@" var chart = new google.visualization.ColumnChart
                                       (document.getElementById('graficobebidas'));");
                _stringBuilder.Append(@"var options = {width: 600, height: 300,title: 'Bebidas mas vendidas',
