...
{
    public class ComandoReporteMembresiasGrafica : Comando<string[], string>
    {
        ...
        /// necesarios para realizar el reporte de los ingresos por membresias, 
        ...
        /// al utilizar el metodo GetDatosIngresosMembresia.
        /// </summary>
        ...
        public override string Ejecutar(string[] n)
        {
            ...
            try
            {
                _tablaDatos = _dao.GetDatosIngresosMembresia(_fi, _ff);
                _stringBuilder.Append(@"<script type=*text/javascript*> 
                                    ...
                                    data.addColumn('number', 'Membresia');");
                ...
                _stringBuilder.Append(@"var chart = new google.visualization.
                                    ImageLineChart(document.getElementById('membresia'));");
                _stringBuilder.Append(@"var options = {width: 600, height: 300,title: 'Ingresos por membresia',
