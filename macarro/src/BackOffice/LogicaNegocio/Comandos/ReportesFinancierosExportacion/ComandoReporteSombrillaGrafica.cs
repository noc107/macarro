...
{
    public class ComandoReporteSombrillaGrafica : Comando<string[], string>
    {
        ...
        /// sombrilla, el metodo crea un string builder que contendrá el codigo scrip html
        ...
        /// al utilizar el metodo GetDatosIngresosSombrilla.
        /// </summary>
        ...
        public override string Ejecutar(string [] n)
        {
            ...
            try
            {
                _dataTable = _dao.GetDatosIngresosSombrilla(_fi, _ff);
                _stringBuilder.Append(@"<script type=*text/javascript*> 
                                    ...
                                    data.addColumn('number', 'Sombrilla');");
                ...
                _stringBuilder.Append(@" var chart = new google.visualization.ImageLineChart
                                   (document.getElementById('sombrilla'));");
