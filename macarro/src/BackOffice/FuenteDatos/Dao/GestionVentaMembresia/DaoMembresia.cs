...
namespace BackOffice.FuenteDatos.Dao.GestionVentaMembresia
{
    public class DaoMembresia : Dao, IDaoMembresia
    {
        ...
        private Membresia LeerTupla(SqlDataReader objetoBD)
        {
            Membresia _membresia = new Membresia();
            try
            {
                _membresia.id = objetoBD.GetInt32(0);
                _membresia.telefono = objetoBD.GetString(1).ToString();
                _membresia.descAplicado = objetoBD.GetFloat(2);
                _membresia.fAdmision = objetoBD.GetDateTime(3);
                _membresia.fVencimiento = objetoBD.GetDateTime(4);
                _membresia.estado = objetoBD.GetString(5).ToString();
                _membresia.Usuario.UsuarioAsociado.Correo = objetoBD.GetString(6).ToString();
                _membresia.Usuario.Nombre = objetoBD.GetString(7).ToString();
                _membresia.Usuario.SegundoNombre = objetoBD.GetString(8).ToString();
                _membresia.Usuario.Apellido = objetoBD.GetString(9).ToString();
                _membresia.Usuario.SegundoApellido = objetoBD.GetString(10).ToString();
                _membresia.Usuario.Cedula = objetoBD.GetString(11).ToString();
                _membresia.Usuario.FechaNacimiento = objetoBD.GetDateTime(12);
                _membresia.Usuario.TipoDocumento = objetoBD.GetString(13).ToString();
                _membresia.pagos = CargarPagos(objetoBD.GetInt32(0));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        private List<Pago> CargarPagos(int _idMembresia)
        {
            ...
            try
            {
                ...
                while (_lectura.Read())
                {
                    _pagos.Add(new Pago(_lectura.GetInt32(0), _lectura.GetFloat(2), _lectura.GetDateTime(1)));
                }
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="id">membresia a modificar</param>
        ...
        public List<Entidad> ConsultarMembresias(string _cadenaGenerica)
        {
            ...
            Entidad _persona = (Persona)FabricaEntidad.ObtenerPersona();
            try
            {
                IniciarConexion().Open();
                ...
                while (_reader.Read())
                {
                    ...
                    _persona = (Persona)FabricaEntidad.ObtenerPersona(0, _reader["PER_docIdentidad"].ToString(), _reader["tipoDocumento"].ToString(),
                    ...
                    _membresias.Add((Membresia)FabricaEntidad.ObtenerMembresia((Persona)_persona, (int)_reader[0], (DateTime)_reader[1], (DateTime)_reader[2],
                        (float)_reader[4], (float)_reader[3], _reader["MEM_telefono"].ToString(), _reader["estadoMembresia"].ToString(), null));
