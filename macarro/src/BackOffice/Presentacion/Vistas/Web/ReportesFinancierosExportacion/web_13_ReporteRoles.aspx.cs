...
{
	public partial class web_13_ReporteRoles : System.Web.UI.Page, IContrato_13_ReporteRoles
	{
		DataTable _dataTable = new DataTable ();

        private Presentador_13_ReporteRoles _presentador;

        public web_13_ReporteRoles()
        {
            _presentador = new Presentador_13_ReporteRoles(this);
        }
        ...
        {
            get { return graficaVaciaRoles; }
            set { graficaVaciaRoles = value; }
        }

        public GridView GridViewRoles
        {
            get { return Roles; }
            set { Roles = value; }
        }
