<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Vistas/Temp/back_office_temp.Master"
    AutoEventWireup="true" CodeBehind="web_13_ReporteUsuarios.aspx.cs"
    Inherits="BackOffice.Presentacion.Vistas.Web.ReportesFinancierosExportacion.web_13_ReporteUsuarios" %>

<asp:Content ID="Content2" ContentPlaceHolderID="css_place_holder" runat="server">
    <link href="../../../comun/resources/css/ModuloReportes/ReporteUsuarios.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <h2 class="" id="subtitulo">Reporte Usuarios</h2>
    <div>
        <asp:Table CssClass="TablaConsulta" ID="Table2" runat="server" Height="100px" Width="400px" align="center">
            <asp:TableRow ID="TableRow6" runat="server">
                <asp:TableCell CssClass="BotonTabla" ID="TableCell16" runat="server" Width="100%" align="center">
                    <asp:Button ID="BuscarBoton" CssClass="Boton" Text="Buscar" runat="server" align="center" Visible ="false"/>
                </asp:TableCell>
            </asp:TableRow>
        ...
        <asp:Table CssClass="TablaConsulta" ID="Table3" runat="server" Height="100px" Width="1200px" align="center">
            ...
            <asp:TableRow>
                ...
                <asp:Label ID="graficaVaciaUsuarios" CssClass="labels" 
                ...
                <asp:TableCell Width="65%">
                 <asp:Label ID="dataTableVaciaUsuarios" CssClass="labels" 
                  runat="server" Text="" Visible="false" Width="100%" align="center" verticalalign="center"></asp:Label>
                    <asp:GridView CssClass="mGrid" ID="Activos" HorizontalAlign="Center" runat="server"
