...
namespace BackOffice.Presentacion.Vistas.Web.ReportesFinancierosExportacion
{
	public partial class web_13_ReporteComidaBebida : System.Web.UI.Page, IContrato_13_ReporteComidaBebida
	{
        ...
        private Presentador_13_ReporteComidaBebida _presentador;

        public web_13_ReporteComidaBebida()
        {
            _presentador = new Presentador_13_ReporteComidaBebida(this);
        }
        ...
        public Label LabelGraficaComida
        {
            get { return graficaVaciaComida; }
            set { graficaVaciaComida = value; }
        }

        public GridView GridViewComidaPopular
        {
            get { return ComidaPopular; }
            set { ComidaPopular = value; }
        }

        public Label LabelGraficaBebida
        {
            get { return graficaVaciaBebida; }
            set { graficaVaciaBebida = value; }
        }

        public GridView GridViewBebidaPopular
        {
            get { return BebidaPopular; }
            set { BebidaPopular = value; }
        }
