...
namespace back_office.Interfaz.web.VentaCierreCaja
{
    public partial class WebForm2 : System.Web.UI.Page, IContrato_07_ImprimirFactura
    {
        ...
        /// <summary>
        /// Metodo al cargar la pagina de imprimir de factura
        /// </summary>
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         //   if (!Page.IsPostBack)
          //  {
                ...
                int _nroFactura = Convert.ToInt32((Request.QueryString["NroFactura"]));             
                
                _presentadorImprimirFactura.mostrarDatosBasicosFactura(_nroFactura);
        ...
        {
            this._presentadorImprimirFactura.gridFactura_PageIndexChanging(e);
        }
