    ...
    <div>
            ...
            <asp:TableRow ID="TableRow3" runat="server">
             ...
             <asp:TableRow ID="TableRow4" runat="server" Visible ="false">
                ...
                <asp:TableCell CssClass="TablaNombre" ID="TableCell7" runat="server">
                    ...
                    <asp:Label CssClass="labels" ID="labelMiembro" runat="server">Miembro:</asp:Label>

                </asp:TableCell><asp:TableCell CssClass="TablaValor"  ID="TableCell8" runat="server">
                    
                    <asp:Label CssClass="labels" ID="Miembro" runat="server" ></asp:Label>
        ...
        <div id="facturaFinal">
            <asp:GridView CssClass="mGrid gestionVentas" ID="gridFactura" runat="server" AutoGenerateColumns="False"
              ...
              GridLines="None" ForeColor="#99CCFF" OnPageIndexChanging="Ventas_PageIndexChanging">
        ...
        <table id="totales">
            ...
            <tr>
                <td></td>
                <td></td>
                <td style="text-align:right;"><label class="labels">IVA 12%</label></td>
                <td style="text-align:center;"><asp:Label ID="montoIva" runat="server" CssClass="labels"></asp:Label></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td style="text-align:right;"><asp:Label ID="labelDescuento" runat="server" CssClass="labels" Text="Descuento" Visible="false"></asp:Label></td>
