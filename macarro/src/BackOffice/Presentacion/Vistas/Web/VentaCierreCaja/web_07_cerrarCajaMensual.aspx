<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaz/temp/back_office_temp.Master" AutoEventWireup="true" CodeBehind="web_07_cerrarCajaMensual.aspx.cs" Inherits="back_office.Interfaz.web.VentaCierreCaja.web_07_cerrarCajaMensual" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <div class="Divporfila;">
        <div class="Estilodivlabels;">
          <h2>Datos del cierre mensual</h2>

        <asp:Table ID="TablaCierreDiario" runat="server"  CssClass="tablaCierreCaja">
