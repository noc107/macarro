...
<asp:Content ID="Content7" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <asp:Label ID="MensajeErrorLista" runat="server" Visible="false" CssClass="avisoMensaje MensajeError"></asp:Label>
    ...
    <asp:Panel ID="_bloquesFacturas" runat="server">
        ...
        <div id="Servicios" class="Bloques">            
            ...
            <div class="gridServicios">
                <asp:GridView CssClass="mGrid" ID="_gridServicios" runat="server" AutoGenerateColumns="false" AllowPaging="True" PageSize="5"
              HorizontalAlign="Center" BorderStyle="None"  AllowSorting="true" GridLines="None" Width="100%" ForeColor="#99CCFF"
              ShowHeaderWhenEmpty="true">  
                    ...
                    <Columns>    
                        ...
                        <asp:BoundField DataField="NombreServicio" HeaderText="Nombre Servicio" ControlStyle-Width="150px">  
        ...
        <div id="Factura" class="Bloques">
            ...
            <div class="gridServicios" style="margin-top: 50px;width:83%;">
                <asp:GridView CssClass="mGrid" ID="_gridDetalleFactura" runat="server" AutoGenerateColumns="false" AllowPaging="True" PageSize="5"
              HorizontalAlign="Center" BorderStyle="None"  AllowSorting="true" GridLines="None" Width="100%" ForeColor="#99CCFF"
              ShowHeaderWhenEmpty="true">  
