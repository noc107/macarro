...
namespace back_office.Interfaz.web.VentaCierreCaja
{
    public partial class web_07_facturacion : System.Web.UI.Page, IContrato_07_Facturacion, IHttpHandler
    {
        ...
        protected void Page_Load(object sender, EventArgs e) 
        {
            ...
            if (Page.IsPostBack)
            {
                this._presentadorFacturacion.CargarDatatable((DataTable)ViewState["dataFactura"], (DataTable)ViewState["dataServicio"]);
                this._bloquesFacturas.Visible = true;
            }
            else
            {
                ViewState["dataFactura"] = this._presentadorFacturacion.Page_Load(Request.QueryString["Modificar"]);
            }
        }
        ...
        protected void Servicios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            this._presentadorFacturacion.Servicios_PageIndexChanging(e);
        }
        
        protected void Factura_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {

            this._presentadorFacturacion.Factura_PageIndexChanging(e);
        }
        ...
        {            
            ...
            this._presentadorFacturacion.AgregarLineaFactura();
            ViewState["dataFactura"] = this._presentadorFacturacion.ActualizarDataTableFactura();
            ViewState["dataServicio"] = this._presentadorFacturacion.ActualizarDataTableServicio();

        }

        protected void botonDeshacerServicio_Click(object sender, ImageClickEventArgs e)
        {
            this._presentadorFacturacion.QuitarLineaFactura();
            ViewState["dataFactura"] = this._presentadorFacturacion.ActualizarDataTableFactura();
            ViewState["dataServicio"] = this._presentadorFacturacion.ActualizarDataTableServicio();
        ...
        {
            ViewState["dataServicio"] = this._presentadorFacturacion.botonCrearFactura();
        }
