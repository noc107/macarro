            ...
            <asp:TableCell>
                <asp:TextBox ID="txtBuscar" runat="server"
                    ...
                    <asp:RegularExpressionValidator ID="expresionRegularBuscar" runat="server" 
                        ...
                        Text="*"
                        ErrorMessage="No se permiten números ni caracteres especiales."
                        ValidationExpression="[a-zA-Z .@-_]{1,20}"
                        ForeColor="Red">
    ...
    <%-- GridView --%>
      <div id="gestionVentas">
        <asp:GridView CssClass="mGrid gestionVentas" ID="Ventas" runat="server" AutoGenerateColumns="False" AllowPaging="True"
         ...
         GridLines="None" ForeColor="#99CCFF" OnPageIndexChanging="Ventas_PageIndexChanging" ShowHeaderWhenEmpty="true" 
          EmptyDataText ="No se encontraron coincidencias" Width="800px">
