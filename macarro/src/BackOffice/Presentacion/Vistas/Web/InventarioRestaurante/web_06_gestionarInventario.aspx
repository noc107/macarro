<%@ Page Title="Gestionar Inventario" Language="C#" MasterPageFile="~/Presentacion/Vistas/Temp/back_office_temp.Master" AutoEventWireup="true" CodeBehind="web_06_gestionarInventario.aspx.cs" Inherits="BackOffice.Presentacion.Vistas.Web.InventarioRestaurante.web_06_gestionarInventario" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="middle_place_holder" runat="server">
    ...
    <asp:Label ID="_mensajeError" CssClass="avisoMensaje MensajeError" runat="server" Text="El item no ha podido ser eliminado debido a que X" Visible="false"></asp:Label>
    </div>
    <br /><br />
...
<asp:TextBox ID="_buscar" runat="server" MaxLength="49" CssClass="textbox TextboxBuscar" placeholder="Buscar Item..."></asp:TextBox>
                <asp:DropDownList ID="_listaBuscar" runat="server" CssClass="combo_box_estatus ComboboxBuscar">
...
<asp:GridView ID="_gridInventario"  CssClass="mGrid filtrar" AllowPaging="true" HorizontalAlign="Center" runat="server" onrowcommand="userGridview_RowCommand"
            ...
            <Columns>    
                ...
                <ItemStyle Width="80px" HorizontalAlign="Center" />
                 ...
                 <asp:BoundField DataField="Estado" HeaderText="Estado" ItemStyle-CssClass="filtro">       
