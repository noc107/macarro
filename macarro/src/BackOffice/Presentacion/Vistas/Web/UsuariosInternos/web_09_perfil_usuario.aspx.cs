...
using BackOffice.Presentacion.Vistas.Web.UsuariosInternos.Recursos;
...
/*
        ...
        protected void ButtonAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (_presentador.ModificarPerfilEmpleado())
            {
                _presentador.MostrarMensajeExito("Cambios guardados exitosamente");
            ...
            {
                _presentador.MostrarMensajeError(RecursosInterfazUsuariosInternos.mensajeDeErrorModificarEmpleado);
