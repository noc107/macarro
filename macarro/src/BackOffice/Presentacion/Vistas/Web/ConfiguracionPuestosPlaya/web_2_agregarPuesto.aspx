<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="web_2_agregarPuesto.aspx.cs" 
    ...
    Inherits="BackOffice.Presentacion.Vistas.Web.ConfiguracionPuestosPlaya.web_2_agregarPuesto" 
    MasterPageFile="~/Presentacion/Vistas/Temp/back_office_temp.Master" %>

<%@ Register Src="~/Presentacion/Vistas/Web/ConfiguracionPuestosPlaya/componentes/formularioAgregarPuesto.ascx" TagPrefix="uc1" TagName="formularioAgregarPuesto" %>
