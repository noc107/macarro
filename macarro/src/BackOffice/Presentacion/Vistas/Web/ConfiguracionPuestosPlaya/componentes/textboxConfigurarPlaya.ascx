<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="textboxConfigurarPlaya.ascx.cs" Inherits="BackOffice.Presentacion.Vistas.Web.ConfiguracionPuestosPlaya.componentes.WebUserControl1" %>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="largoDeLaPlaya" runat="server" CssClass="textbox" MaxLength="8"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="anchoDeLaPlaya" runat="server" CssClass="textbox" MaxLength="8"></asp:TextBox>
