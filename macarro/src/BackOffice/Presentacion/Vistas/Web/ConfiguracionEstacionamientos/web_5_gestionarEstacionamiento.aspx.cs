...
{
    public partial class web_5_gestionarEstacionamiento : System.Web.UI.Page, IContrato_5_gestionarEstacionamiento
    {
        ...
        private Presentador_5_gestionarEstacionamiento _presentador;

        public web_5_gestionarEstacionamiento()
        {
            _presentador = new Presentador_5_gestionarEstacionamiento(this);
        }
        ...
        string IContrato_5_gestionarEstacionamiento.LabelNombre
        {
            get { return _nombreEstacionamiento.Text; }
            set { _nombreEstacionamiento.Text = value; }
        }

        string IContrato_5_gestionarEstacionamiento.LabelCapacidad
        {
            get { return _capacidad.Text; }
            set { _capacidad.Text = value; }
        }

        string IContrato_5_gestionarEstacionamiento.LabelEstado
        {
            get { return _estado.Text; }
            set { _estado.Text = value; }
        }

        string IContrato_5_gestionarEstacionamiento.LabelPerdido
        {
            get { return _tarifaPerdido.Text; }
            set { _tarifaPerdido.Text = value; }
        }

        string IContrato_5_gestionarEstacionamiento.LabelTarifa
        {
