<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Vistas/Temp/back_office_temp.Master" UnobtrusiveValidationMode="None" AutoEventWireup="true"   CodeBehind="web_11_editarEstacionamiento.aspx.cs" Inherits="BackOffice.Presentacion.Vistas.Web.ConfiguracionEstacionamientos.web_11_editarEstacionamiento" %>
        ...
        <asp:TableRow>
            <asp:TableCell>
                <div class="boton_centrado">
                    <asp:Button ID="b_aceptar" runat="server" CssClass="Boton" Text="Aceptar" OnClick="BotonAceptar_Click"/>
                </div>
            </asp:TableCell>
            <asp:TableCell>
                <div class="boton_centrado">
                    <asp:Button ID="b_cancelar" runat="server" CssClass="Boton" Text="Cancelar" OnClick="BotonCancelar_Click" CausesValidation="false"/>
                </div> 
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
