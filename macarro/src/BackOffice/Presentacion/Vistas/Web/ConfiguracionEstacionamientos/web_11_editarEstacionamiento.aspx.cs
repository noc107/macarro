...
{
    public partial class web_11_editarEstacionamiento : System.Web.UI.Page, IContrato_11_editarEstacionamiento
    {
        //List<Estacionamiento> _listaEstacionamiento = new List<Estacionamiento>();
        //private String id;

        private Presentador_11_editarEstacionamiento _presentador;

        public web_11_editarEstacionamiento()
        {
            _presentador = new Presentador_11_editarEstacionamiento(this);
        }
        ...
        string IContrato_11_editarEstacionamiento.TextboxNombre
        {
            get { return tb_nombre.Text; }
            set { tb_nombre.Text = value; }
        }

        string IContrato_11_editarEstacionamiento.TextboxCapacidad
        {
            get { return tb_Capacidad.Text; }
            set { tb_Capacidad.Text = value; }
        }

        string IContrato_11_editarEstacionamiento.TextboxTarifa
        {
            get { return tb_Tarifa.Text; }
            set { tb_Tarifa.Text = value; }
        }

        string IContrato_11_editarEstacionamiento.TextboxPerdido
        {
            get { return tb_tarifaTicketPerdido.Text; }
            set { tb_tarifaTicketPerdido.Text = value; }
        }

        int IContrato_11_editarEstacionamiento.TextboxEstado
        {
        ...
        {
            Response.Redirect("web_11_gestionarEstacionamiento.aspx");
