...
namespace BackOffice.Presentacion.Presentadores.ConfiguracionPuestosPlaya
{
    public class Presentador_2_consultarInventario : PresentadorGeneral
    {
        ...
        {          
            Comando<string, List<Entidad>> ComandoConsultarInventario = FabricaComando.ObtenerComandoConsultarInventario();
            List<Entidad>  _listaDesdeComando = ComandoConsultarInventario.Ejecutar(parametro);
