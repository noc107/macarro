...
BEGIN
DECLARE @tipo int;
    SET @tipo = (select EST_id from ESTADO where EST_nombre = 'Empleado' and EST_pertenece ='Usuario');
...
'cbf2997a7f96a7a45a556bb083c0698a', 'Cliente', 'Activado', null, null, '¿Cuál es el nombre de su abuelo paterno?', 
'Enrique', '04167453354';
/*Clave Yoly123*/
commit transaction;
go
...
eXEC Procedure_consultarEmpleadoClave 'ybucherenick@gmail.com','cbf2997a7f96a7a45a556bb083c0698a';
